...
from datasets import  nextbutton_to_tfrecords
...
def main(_):
    ...
    elif FLAGS.dataset_name == 'nextbutton':
        nextbutton_to_tfrecords.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name)
    else:
